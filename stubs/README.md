...
```sh
python3 -m pip install ignition-api-stubs 'mypy[python2]==0.971'
```
...
[CONTRIBUTING.md]: https://github.com/ignition-devs/ignition-api/blob/8.3/CONTRIBUTING.md
...
[`ignition-api/8.3`]: https://github.com/ignition-devs/ignition-api/tree/8.3
[LICENSE]: https://github.com/ignition-devs/ignition-api/blob/8.3/LICENSE
